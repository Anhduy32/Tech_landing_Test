...
<head>
    ...
    <meta name="description" content="HeliTech - Hệ thống cửa hàng bán lẻ điện thoại, phụ kiện công nghệ chính hãng, uy tín.">
    
    <title><?= htmlspecialchars($title ?? 'HeliTech - Thế Giới Công Nghệ') ?></title>
    
    <!-- 1. PRECONNECT TĂNG TỐC MẠNG -->
    <link rel="preconnect" href="https://fonts.googleapis.com">
    <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
    <link rel="preconnect" href="https://images.unsplash.com">
    <link rel="preconnect" href="https://cdn.tailwindcss.com">
    
    <!-- 2. LCP IMAGE PRELOAD (Vũ khí tối thượng cho tốc độ) -->
    ...
    <!-- 4. TAILWIND CSS (Dùng defer để lấy lại 800ms) -->
    <script>
        window.tailwind = {
            config: {
                theme: {
