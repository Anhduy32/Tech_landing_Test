    ...
    <div class="container mx-auto px-6 lg:px-10 relative z-10">
        <div class="grid lg:grid-cols-2 gap-10 items-center min-h-screen lg:min-h-[760px] py-16 lg:py-0">
            <div class="text-white flex flex-col justify-center">
                <div>
                    <span class="inline-flex items-center gap-2 bg-red-500/15 border border-red-400/30 px-4 py-1.5 rounded-full text-red-200 text-sm md:text-base font-semibold backdrop-blur-md">SIÊU PHẨM 2026</span>
                </div>
                ...
                <p class="mt-6 md:mt-8 text-gray-300 text-base md:text-lg leading-7 md:leading-8 max-w-xl">
                    Khung Titan chuẩn hàng không vũ trụ. Chip <strong class="text-white">A17 Pro</strong> mạnh mẽ. Camera 48MP chuyên nghiệp.
                </p>
                <div class="flex flex-col sm:flex-row gap-4 mt-8 md:mt-10">
                    <a href="#shop" class="w-full sm:w-auto text-center px-8 py-4 rounded-full bg-gradient-to-r from-red-600 to-red-500 font-bold shadow-[0_15px_45px_rgba(215,0,24,.45)] hover:scale-105 transition-transform duration-300">🛒 MUA NGAY</a>
                    <a href="#specs" class="w-full sm:w-auto text-center px-8 py-4 rounded-full border border-white/20 backdrop-blur-md hover:bg-white hover:text-black transition-colors duration-300">XEM CHI TIẾT</a>
                </div>
            </div>
            ...
            <div class="relative flex justify-center items-center mt-8 lg:mt-0">
                ...
                <img src="https://images.unsplash.com/photo-1695048133142-1a20484d2569?q=80&w=400&auto=format&fit=crop&fm=webp" 
                    ...
                    fetchpriority="high" decoding="sync" width="400" height="480"
            ...
            <?php foreach ($products as $product): ?>
                <div class="bg-white rounded-lg p-3 md:p-4 tech-shadow relative flex flex-col justify-between group">
                    <div class="w-full aspect-square mb-3 md:mb-4 overflow-hidden">
                        <img src="<?= htmlspecialchars($product['image']) ?>" alt="<?= htmlspecialchars($product['name']) ?>" loading="lazy" decoding="async" class="w-full h-full object-contain group-hover:-translate-y-2 transition duration-300">
                    </div>
                    <div>
...
<section id="promo" class="container mx-auto px-4 md:px-8 mb-12" data-aos="fade-up">
    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div class="bg-gray-800 rounded-lg overflow-hidden flex items-center p-5 md:p-8 h-[200px] relative">
            ...
            <img src="https://images.unsplash.com/photo-1611186871348-b1ce696e52c9?q=80&w=300&auto=format&fit=crop&fm=webp" loading="lazy" decoding="async" class="absolute right-0 top-0 h-full w-1/2 object-cover opacity-80" alt="Phụ kiện Apple">
            <div class="absolute inset-0 bg-gradient-to-r from-gray-800 via-gray-800/80 to-transparent w-2/3 pointer-events-none"></div>
        </div>
        
        <div class="bg-gray-800 rounded-lg overflow-hidden flex items-center p-5 md:p-8 h-[200px] relative">
            <div class="relative z-10 w-full max-w-[60%] text-white">
                <h3 class="text-lg md:text-2xl font-black mb-2 uppercase text-brand-red leading-tight">Tai nghe Sony</h3>
                <p class="text-xs md:text-sm mb-4">Âm thanh đỉnh cao, chống ồn chủ động.</p>
            </div>
            <!-- Ảnh ngang, không bị lẹm viền -->
            <img src="https://images.unsplash.com/photo-1505740420928-5e560c06d30e?q=80&w=300&auto=format&fit=crop&fm=webp" loading="lazy" decoding="async" class="absolute right-0 top-0 h-full w-[55%] object-cover opacity-80" alt="Tai nghe Sony">
            <div class="absolute inset-0 bg-gradient-to-r from-gray-800 via-gray-800/80 to-transparent w-2/3 pointer-events-none"></div>
        </div>
    </div>
</section>
...
<!-- ================= FEATURES SECTION ================= -->
<section class="bg-white border-y border-brand-red py-6 md:py-8 mb-12 md:mb-16">
    <div class="container mx-auto px-4 md:px-8 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6">
        <div class="flex items-center gap-4 justify-start p-2">
            <div class="text-brand-red shrink-0"><svg class="h-8 w-8 md:h-10 md:w-10" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 19l9 2-9-18-9 18 9-2zm0 0v-8" /></svg></div>
            <div>
                <h4 class="font-bold text-sm md:text-base text-brand-dark">Giao hàng cực nhanh</h4>
                <p class="text-xs md:text-sm text-gray-600 mt-0.5">Miễn phí toàn quốc</p>
            </div>
        </div>
        <div class="flex items-center gap-4 justify-start p-2">
            <div class="text-brand-red shrink-0"><svg class="h-8 w-8 md:h-10 md:w-10" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z" /></svg></div>
            <div>
                <h4 class="font-bold text-sm md:text-base text-brand-dark">Bảo hành 12 tháng</h4>
                <p class="text-xs md:text-sm text-gray-600 mt-0.5">Đổi trả trong 30 ngày</p>
            </div>
        </div>
        <div class="flex items-center gap-4 justify-start p-2">
            ...
            <div>
                ...
                <p class="text-xs md:text-sm text-gray-600 mt-0.5">Thủ tục nhanh gọn</p>
            </div>
        </div>
        <div class="flex items-center gap-4 justify-start p-2">
            ...
            <div>
                ...
                <p class="text-xs md:text-sm text-gray-600 mt-0.5">Hỗ trợ kỹ thuật 24/7</p>
            </div>
        </div>
    </div>
</section>